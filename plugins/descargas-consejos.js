import translate from '@vitalets/google-translate-api' 
 ...
 let frep = { contextInfo: { externalAdReply: {title: wm, body: author, sourceUrl: redesMenu.getRandom(), thumbnail: await(await fetch(wittyMenu.getRandom())).buffer() }}} 
 ...
 *ღ _${result.text}_* 
 ...
 let list = (await axios.get(`https://raw.githubusercontent.com/gabicota16/Witty-Bot/master/src/JSON/frase2.json`)).data   
