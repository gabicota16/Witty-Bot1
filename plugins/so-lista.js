...
if (chat.audios && m.text.match(/(Porque ta tite|Ta tite|Por qué ta tite|🥺|😕|😟|😞|😔)/gi)) {    
...
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
 ...
 (chat.audios && m.text.match(/(hola|hello|Hola)/gi)) {    
...
if (chat.audios && m.text.match(/(13|12+1|6+7|10+3|9+4|5+8|20-7|trece|trese|Trece|Trese)/gi)) {    
let vn = './media/13.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
