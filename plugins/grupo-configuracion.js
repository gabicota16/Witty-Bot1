/*import fetch from 'node-fetch'  
 ...
 let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: ig, mediaType: 'VIDEO', description: '', title: wm, body: '𝗦𝘂𝗽𝗲𝗿 𝗪𝗶𝘁𝘁𝘆-𝗕𝗼𝘁', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: ig }}} 
 let dos = [enlace, enlace2]     
 const pp = await conn.profilePictureUrl(m.chat, 'image').catch(_ => null) || './src/grupos.jpg'  
 const { reaction, antifake, antiTwitter, antiInstagram, antiFacebook, antiTelegram, antiYoutube, antiTiktok, isBanned, autolevelup, antiver, antitoxic, temporal, restrict, stickers, welcome, detect, sWelcome, sBye, sPromote, sDemote, antiLink, antiLink2, autosticker, audios, delete: del } = global.db.data.chats[m.chat] 
