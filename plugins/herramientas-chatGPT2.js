import fetch from 'node-fetch' 
 ...
 const config = { method: 'post', url: 'https://api.openai.com/v1/chat/completions', headers: { 'Content-Type': 'application/json', 'Authorization': 'Bearer ' + global.openai_key }, data: JSON.stringify({ 'model': 'gpt-3.5-turbo', 'messages': [{ role: 'system', content: 'Bot de WhatsApp el cual fue creado por Gabriel, tu seras WittyBot' }, ...chgptdb ]})} 
 ...
 handler.command = ['openai2', 'chatgpt2', 'ia2', 'robot2', 'Witty', 'WittyBot'] 
