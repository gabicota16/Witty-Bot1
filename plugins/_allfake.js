import { generateWAMessageFromContent } from "@adiwajshing/baileys" 
 ...
 let sgh = md 
 let sgc = nna
 let witty = 'https://i.imgur.com/EXTbyyn.jpg' 
 //let logo = 'https://i.pinimg.com/564x/f7/d2/e4/f7d2e48fd59a8c01cd396bfc70b0a2d1.jpg' 
 let pp = await conn.profilePictureUrl(who).catch(_ => witty) 
 ...
 //global.enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '𝗦𝘂𝗽𝗲𝗿 𝗪𝗶𝘁𝘁𝘆-𝗕𝗼𝘁', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}} 
 ...
 /*let adReply = { fileLength: fsizedoc, seconds: fsizedoc, contextInfo: { forwardingScore: fsizedoc, externalAdReply: { showAdAttribution: true, title: wm, body: '👋 ' + username, mediaUrl: ig, description: 'Hola', previewType: 'PHOTO', thumbnail: await(await fetch(wittyMenu.getRandom())).buffer(), sourceUrl: redesMenu.getRandom() }}}         
