import { sticker } from '../lib/sticker.js' 
 ...
 let text 
    ...
    if (text.length > 30) return m.reply('𝙈𝘼𝙓𝙄𝙈𝙊 30 𝙋𝘼𝙇𝘼𝘽𝙍𝘼𝙎!') 
     let pp = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHnCY2xk-LygzmURh6OTByDcV0gn6f7G1AAA&usqp=CAU') 
