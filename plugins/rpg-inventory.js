import daily from './rpg-daily.js'  
 ...
 ┃ ${rpgg.emoticon('money')} *WittyCoins: » ${money}* 
 ...
 _2.Top WittyCoins_ *${usersmoney.indexOf(m.sender) + 1}* _de_ *${usersmoney.length}* 
 ...
 *│ ⛏️💸 Minar WittyCoins » ${new Date - user.lastcoins < 600000 ? '❌' : '✅'}* 
